# save html page
#BDTcurl -s https://www.spec.org/cpu2006/results/rint2006.html > specint2006.html
# convert to text
#BDTtextutil -convert txt "specint2006.html"
...
awk -F';' '{gsub(" ","\\ ",$NF);gsub("\,","\\,",$NF);print "specint_meas,cpu_type="$NF" specval="$1}' specint.txt
